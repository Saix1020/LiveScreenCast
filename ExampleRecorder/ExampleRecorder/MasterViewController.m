...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    NSTimer* time = [NSTimer timerWithTimeInterval:3 target:self selector:@selector(addNewObject) userInfo:nil repeats:YES];
...
//    [self.tableView insertRowsAtIndexPaths:@[indexPath] withRowAnimation:UITableViewRowAnimationAutomatic];
    if (currentIndex.row == 0) {
        currentIndex = [NSIndexPath indexPathForRow:_colors.count-1 inSection:0];
